...
model = Unet_with_slice(input_img,32,0.3,True)
...
# data preprocessing starts here
  ...
  model.save('/content/drive/MyDrive/models/2dincr_4class_axis2.h5')
  ...
  plt.ylabel('Loss')
  plt.xlabel('epochs')
  s = '/content/drive/MyDrive/SAVEFIG/epochwise_loss_incraxis2' + str(epochs)
  plt.savefig(s)
  plt.show()
  plt.close()
  ...
  plt.ylabel('Accuracy')
  plt.xlabel('epochs')
  s = '/content/drive/MyDrive/SAVEFIG/epochwise_accu_incraxis2' + str(epochs)
  plt.savefig(s)
  plt.show()
  plt.close()
  ...
  plt.ylabel('accuracy')
  plt.xlabel('epoch')
  s = '/content/drive/MyDrive/SAVEFIG/accuracy_plotincraxis2' + str(epochs)
  plt.savefig(s)
  plt.show()
  plt.close()
  ...
  plt.ylabel('loss')
  plt.xlabel('epoch')
  s = '/content/drive/MyDrive/SAVEFIG/loss_plot_incraxis2' + str(epochs)
  plt.savefig(s)
  plt.show()
  plt.close()
