...
# data preprocessing starts here
  ...
  model.save('/content/drive/MyDrive/models/2dincr_4class_axis1.h5')
  ...
  plt.ylabel('Loss')
  plt.xlabel('epochs')
  s = '/content/drive/MyDrive/SAVEFIG/epochwise_loss_incr' + str(epochs)
  plt.savefig(s)
  plt.show()
  plt.close()
  ...
  plt.ylabel('Accuracy')
  plt.xlabel('epochs')
  s = '/content/drive/MyDrive/SAVEFIG/epochwise_accu_incr' + str(epochs)
  plt.savefig(s)
  plt.show()
  plt.close()
  ...
  plt.ylabel('accuracy')
  plt.xlabel('epoch')
  s = '/content/drive/MyDrive/SAVEFIG/accuracy' + str(epochs)
  plt.savefig(s)
  plt.show()
  plt.close()
  ...
  plt.ylabel('loss')
  plt.xlabel('epoch')
  s = '/content/drive/MyDrive/SAVEFIG/loss_plot_incr' + str(epochs)
  plt.savefig(s)
  plt.show()
  plt.close()
